...
| `0.3.0` | Dataset OpenCUP statico + lookup browser | Pipeline mensile, indice CUP esatto su GitHub Releases, verifica esistenza CUP da web e Python, cache locale/browser, nuovi esiti OpenCUP | nessuna |
...
10. ADR per strategia statica GitHub Releases + browser lookup (ADR 0007).
